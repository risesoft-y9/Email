 ...
 * @LastEditTime: 2024-08-14 17:04:28
 * @LastEditors: mengjuhua
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: /sz- team-frontend-9.6.x/y9vue-email/src/layouts/components/SiderMenu.vue
-->
<template>
    <!-- <div id="y9-menu"> -->
    <el-menu
    ...
    const newMenuData = computed<RoutesDataItem[]>(() => {
        ...
        for (let index = 0, len = menuData.value.length; index < len; index += 1) {
            ...
            if (!route.hidden && route.children) {
                route.children.length === 1 && !route.meta?.isDynamic
