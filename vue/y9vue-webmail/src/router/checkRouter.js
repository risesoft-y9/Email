 ...
 * @LastEditTime: 2022-11-21 11:00:38
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: /sz-team-frontend-9.5.x/y9vue-email/src/router/checkRouter.js
 */
        ...
        if (!to.name) {
            ...
            array.forEach((item) => {
                if (item.path === to.path && item.name) {
                    ...
                    console.log('6666666666666666666666666666666', item);
                    router.push({ path: item.path, query: to.query });
                }
            });
        } else {
            return true;
